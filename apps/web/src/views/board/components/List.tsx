...
interface ListProps {
  ...
  onHoverStart?: (publicListId: PublicListId) => void;
  onHoverEnd?: (publicListId: PublicListId) => void;
}
    ...
    >
      {(provided) => (
        <div
          ...
          onMouseEnter={() => onHoverStart?.(list.publicId)}
          onMouseLeave={() => onHoverEnd?.(list.publicId)}
