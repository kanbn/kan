ALTER TYPE "public"."card_activity_type" ADD VALUE 'card.updated.blocker.added' BEFORE 'card.updated.comment.added';
ALTER TYPE "public"."card_activity_type" ADD VALUE 'card.updated.blocker.removed' BEFORE 'card.updated.comment.added';
