ALTER TYPE "public"."card_activity_type" ADD VALUE IF NOT EXISTS 'card.updated.blocker.removed' BEFORE 'card.updated.comment.added';
ALTER TYPE "public"."card_activity_type" ADD VALUE IF NOT EXISTS 'card.updated.blocker.added' BEFORE 'card.updated.blocker.removed';
...
ALTER TABLE "_card_blocking" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN
